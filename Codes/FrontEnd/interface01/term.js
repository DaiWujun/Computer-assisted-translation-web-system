...
// });
// 获取翻译记忆库按钮
var translationMemoryButton = document.querySelector('.nav li:nth-child(2) a');

// 获取主页面按钮
var mainInterfaceButton = document.querySelector('.nav li:nth-child(1) a');
...
// 为主页面按钮添加点击事件
mainInterfaceButton.addEventListener('click', function() {
  window.location.href = 'http://10.16.83.25:8080/html/main%20interface.html';
});
